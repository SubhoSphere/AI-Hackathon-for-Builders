...
import { FolderGit2, FolderGitIcon, Loader2, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="w-full max-w-md bg-zinc-900 border border-white/10 rounded-3xl p-8 shadow-2xl shadow-black/50 text-center relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="text-slate-400 mb-6 text-sm max-w-[280px]">
          Sign in to securely connect your repositories and start auditing your code.
        </p>

        {error && (
          <div className="mb-6 w-full p-4 bg-red-500/10 border border-red-500/20 rounded-xl flex items-center justify-center gap-2 text-red-400 text-sm">
            <AlertCircle className="w-4 h-4 text-red-400 shrink-0" />
            <span className="text-left font-medium">Authentication Error: {error}</span>
          </div>
        )}
